...
def compareSparseData():
    ...
    axsP[0].set_xticklabels([r'\textrm{modeling}', r'\textrm{experiment}'])
    ...
    axsP[1].set_xticklabels([r'\textrm{modeling}', r'\textrm{experiment}'])
    ...
    axsT[0].set_ylabel(r'\textrm{time [h]}')
    ...
    axsT[0].set_xticklabels([r'\textrm{modeling}', r'\textrm{experiment}'])
    ...
    axsT[1].set_xticklabels([r'\textrm{modeling}', r'\textrm{experiment}'])
    figT.tight_layout()
    ...
    axsM[0].set_ylabel(r'\textrm{mass [g]}')
    axsM[0].set_title(r'\textrm{\textbf{\Large 3a: mobile gaseous CO$_2$}}')
    axsM[0].set_xticks([1.5, 3.0])
    axsM[0].set_xticklabels([r'\textrm{modeling}', r'\textrm{experiment}'])
    visualizeRow(1e3*means[5, :], 1e3*stddevs[5, :], 1e3*expData[5, :], axsM[1], colors)
    axsM[1].set_title(r'\textrm{\textbf{\Large 3c: CO$_2$ dissolved in liquid phase}}')
    # axsM[1].set_ylim((-0.01, 4.0))
    axsM[1].set_xticks([1.5, 3.0])
    axsM[1].set_xticklabels([r'\textrm{modeling}', r'\textrm{experiment}'])
    ...
    axsM[2].set_xticklabels([r'\textrm{modeling}', r'\textrm{experiment}'])
    visualizeRow(1e3*means[9, :], 1e3*stddevs[9, :], 1e3*expData[9, :], axsM[3], colors)
    axsM[3].set_title(r'\textrm{\textbf{\Large 4c: CO$_2$ dissolved in liquid phase}}')
    axsM[3].set_xticks([1.5, 3.0])
    axsM[3].set_xticklabels([r'\textrm{modeling}', r'\textrm{experiment}'])
    figM.tight_layout()
    ...
    axsS.set_ylabel(r'\textrm{mass [g]}')
    axsS.set_title(r'\textrm{\textbf{\Large 6: total CO$_2$ mass in top seal facies in Box A at 120\,h}}')
    axsS.set_ylim((0.0, 0.7))
    axsS.set_xticks([1.5, 3.0])
    axsS.set_xticklabels([r'\textrm{modeling}', r'\textrm{experiment}'])
    figS.tight_layout()
