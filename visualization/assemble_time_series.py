...
def assembleTimeSeries():
    ...
    fileNames = ["../../austin/time_series.csv",
                 ...
                 "../../delft/time_series.csv",
                 "../../herriot-watt/20220105-HighCapDifftime_series.csv",
                 "../../lanl/time_series.csv",
                 "../../melbourne/time_series.csv",
                 "../../stanford/time_series.csv",
                 "../../stuttgart/time_series.csv"]
    groups = ["Austin", "CSIRO", "Delft", "Herriot-Watt", "LANL", "Melbourne", "Stanford", "Stuttgart"]
