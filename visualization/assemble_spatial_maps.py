...
def assembleSpatialMaps():
    for field in ["saturation", "concentration"]:
        ...
        cropImage(f'../../delft/delft-DARSim/figures/spatial_map_{field}.png', 0, 989, 0, 258, 'delft_darsim_24.png')
        cropImage(f'../../delft/delft-DARTS/figures/spatial_map_{field}.png', 0, 989, 0, 258, 'delft_darts_24.png')
        cropImage(f'../../herriot-watt/figures/spatial_map_{field}.png', 0, 989, 0, 258, 'herriot-watt_24.png')
        cropImage(f'../../lanl/figures/spatial_map_{field}.png', 0, 989, 0, 258, 'lanl_24.png')
        cropImage(f'../../melbourne/Figures/spatial_map_{field}.png', 0, 989, 0, 258, 'melbourne_24.png')
        ...
        subprocess.run(["convert", "temp.png", "-font", "helvetica", "-fill", "white", "-pointsize", "24",
                        ...
                        "+1060+190", "Delft-DARSim", "-annotate", "+60+415", "Delft-DARTS", "-annotate", "+560+415",
                        "Heriot-Watt", "-annotate", "+1060+415", "LANL", "-annotate", "+60+640", "Melbourne",
                        "-annotate", "+560+640", "Stanford", "-annotate", "+1060+640", "Stuttgart", f"{field}_24h.png"])
        ...
        cropImage(f'../../delft/delft-DARSim/figures/spatial_map_{field}.png', 500, 499, 0, 258, 'delft_darsim_48.png')
        cropImage(f'../../delft/delft-DARTS/figures/spatial_map_{field}.png', 500, 499, 0, 258, 'delft_darts_48.png')
        cropImage(f'../../herriot-watt/figures/spatial_map_{field}.png', 500, 499, 0, 258, 'herriot-watt_48.png')
        cropImage(f'../../lanl/figures/spatial_map_{field}.png', 500, 499, 0, 258, 'lanl_48.png')
        cropImage(f'../../melbourne/Figures/spatial_map_{field}.png', 500, 499, 0, 258, 'melbourne_48.png')
        ...
        subprocess.run(["convert", "temp.png", "-font", "helvetica", "-fill", "white", "-pointsize", "24",
                        ...
                        "+1050+195", "Delft-DARSim", "-annotate", "+55+425", "Delft-DARTS", "-annotate", "+550+425",
                        "Heriot-Watt", "-annotate", "+1050+425", "LANL", "-annotate", "+55+655", "Melbourne",
                        "-annotate", "+550+655", "Stanford", "-annotate", "+1050+655", "Stuttgart", f"{field}_48h.png"])
        ...
        cropImage(f'../../delft/delft-DARSim/figures/spatial_map_{field}.png', 994, 5, 0, 258, 'delft_darsim_72.png')
        cropImage(f'../../delft/delft-DARTS/figures/spatial_map_{field}.png', 994, 5, 0, 258, 'delft_darts_72.png')
        cropImage(f'../../herriot-watt/figures/spatial_map_{field}.png', 994, 5, 0, 258, 'herriot-watt_72.png')
        cropImage(f'../../lanl/figures/spatial_map_{field}.png', 994, 5, 0, 258, 'lanl_72.png')
        cropImage(f'../../melbourne/Figures/spatial_map_{field}.png', 994, 5, 0, 258, 'melbourne_72.png')
        ...
        subprocess.run(["convert", "temp.png", "-font", "helvetica", "-fill", "white", "-pointsize", "24",
                        ...
                        "+1050+195", "Delft-DARSim", "-annotate", "+55+425", "Delft-DARTS", "-annotate", "+550+425",
                        "Heriot-Watt", "-annotate", "+1050+425", "LANL", "-annotate", "+55+655", "Melbourne",
                        "-annotate", "+550+655", "Stanford", "-annotate", "+1050+655", "Stuttgart", f"{field}_72h.png"])
        ...
        cropImage(f'../../delft/delft-DARSim/figures/spatial_map_{field}.png', 7, 992, 254, 8, 'delft_darsim_96.png')
        cropImage(f'../../delft/delft-DARTS/figures/spatial_map_{field}.png', 7, 992, 254, 8, 'delft_darts_96.png')
        cropImage(f'../../herriot-watt/figures/spatial_map_{field}.png', 7, 992, 254, 8, 'herriot-watt_96.png')
        cropImage(f'../../lanl/figures/spatial_map_{field}.png', 7, 992, 254, 8, 'lanl_96.png')
        cropImage(f'../../melbourne/Figures/spatial_map_{field}.png', 7, 992, 254, 8, 'melbourne_96.png')
        ...
        subprocess.run(["convert", "temp.png", "-font", "helvetica", "-fill", "white", "-pointsize", "24",
                        ...
                        "+1050+190", "Delft-DARSim", "-annotate", "+55+415", "Delft-DARTS", "-annotate", "+550+415",
                        "Heriot-Watt", "-annotate", "+1050+415", "LANL", "-annotate", "+55+640", "Melbourne",
                        "-annotate", "+550+640", "Stanford", "-annotate", "+1050+640", "Stuttgart", f"{field}_96h.png"])
        ...
        cropImage(f'../../delft/delft-DARSim/figures/spatial_map_{field}.png', 500, 499, 254, 8, 'delft_darsim_120.png')
        cropImage(f'../../delft/delft-DARTS/figures/spatial_map_{field}.png', 500, 499, 254, 8, 'delft_darts_120.png')
        cropImage(f'../../herriot-watt/figures/spatial_map_{field}.png', 500, 499, 254, 8, 'herriot-watt_120.png')
        cropImage(f'../../lanl/figures/spatial_map_{field}.png', 500, 499, 254, 8, 'lanl_120.png')
        cropImage(f'../../melbourne/Figures/spatial_map_{field}.png', 500, 499, 254, 8, 'melbourne_120.png')
        ...
        subprocess.run(["convert", "temp.png", "-font", "helvetica", "-fill", "white", "-pointsize", "24",
                        ...
                        "+1050+190", "Delft-DARSim", "-annotate", "+55+415", "Delft-DARTS", "-annotate", "+550+415",
                        "Heriot-Watt", "-annotate", "+1050+415", "LANL", "-annotate", "+55+640", "Melbourne",
                        "-annotate", "+550+640", "Stanford", "-annotate", "+1050+640", "Stuttgart", f"{field}_120h.png"])
